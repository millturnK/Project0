...
public class MainActivity extends AppCompatActivity {
    ...
    /** Called when the user touches the button. Am just using the one function for all btn
     * messages and passing in the app name from the btn as I abhore duplication. */
